...
def sarima_predict(df, column, training_start_index,training_end_index, prediction_length):
  ...
  plt.plot(df[column][forecast_index[-1]:], color="royalblue", label="historical data")
  plt.legend()
  plt.show()
